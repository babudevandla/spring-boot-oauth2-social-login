...
.login_form {
	width: 55%;
	//background: url("${pageContext.request.contextPath}/images/border.png") no-repeat 331px 77px;
	float: left;
	position: relative;
}
.login-form{
				...
				<form class="login_form" name='loginForm' action="<c:url value='../j_spring_security_check' />" method='POST'>
					...
					<ul>
						<li>
							...
							<p><img src="${pageContext.request.contextPath}/images/contact.png" alt=""></p>
						</li>
						<li>
							<input type="password" id="password" name="j_password" class="textbox2" placeholder="Password">
							<p><img src="${pageContext.request.contextPath}/images/lock.png" alt=""></p>
						</li>
					</ul>
			...
			<div class="account">
				...
				<div class="span">
                	<a  href="<c:url value='/oauth2/authorization/google' />" >
                		<img src="<c:url value='/static/img/gmail2.png' />" alt="">
                		<button type="submit">
				...
				<%-- <div class="span1">
					<form name='TwitterSocialloginForm'
            		  action="<c:url value='${pageContext.request.contextPath}/auth/twitter?scope=email,user_about_me,user_birthday' />" method='POST'>
						<img src="<c:url value='/static/img/twitter.png' />" alt="">
						<button type="submit">
				...
				<div class="span2">
					<a href="<c:url value='/oauth2/authorization/linkedin' />">
						<img src="<c:url value='/static/img/linkedin.png'/>" alt="">
						<button type="submit">
							<i>Login with Linkedin</i>
						</button>	
					</a>
				</div>
				<div class="span3">
					<a  href="<c:url value='/oauth2/authorization/facebook' />" >
							<img src="<c:url value='/static/img/facebook.png' />" alt="">
							<button type="submit">
				...
				<div class="span3">
					<a href="<c:url value='/oauth2/authorization/github' />" >
							<img src="<c:url value='/static/img/github.png' />" alt="">
							<button type="submit">
