...
<body>
	<section>
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-12 mx-auto px-0" style="top: 23px;">
							...
							<div>
								<form class="login_form" name='loginForm' action="<c:url value='/login' />" method='POST' accept-charset=utf-8>
									...
									<div class="form-group">
										...
										<input type="email" class="form-control" id="username" name="j_username" placeholder="Enter email address"
											required="required">
									</div>
									<div class="form-group">
