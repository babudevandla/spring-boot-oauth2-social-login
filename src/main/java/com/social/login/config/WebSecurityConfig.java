...
import com.social.login.oauth2.CustomOAuth2UserService;
import com.social.login.oauth2.CustomOidcUserService;
import com.social.login.oauth2.OAuth2AccessTokenResponseConverterWithDefaults;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().and().formLogin()//
				...
				.oauth2Login().loginPage("/login").failureHandler(authenticationFailureHandler).defaultSuccessUrl("/home")
				.userInfoEndpoint()
